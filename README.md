[Wasabi Wallet] is an open-source, non-custodial, privacy focused Bitcoin wallet for desktop. It implements a trustless privacy technique, called [Chaumian CoinJoin](https://github.com/nopara73/ZeroLink/).

This is Wasabi Wallet's open-source [documentation] repository.
...
If you have a question regarding the documentation, please [open an issue](https://github.com/Wasabi-Wallet/WasabiDoc/issues).
If you have an answer to a question, please [open a pull request](https://github.com/Wasabi-Wallet/WasabiDoc/pulls).
For more details on how to contribute, see the [contribution checklist] or the [to-do] list.

If you need help regarding the software specifically, please check out [Discussions](https://github.com/Wasabi-Wallet/WalletWasabi/discussions) in Wasabi Wallet's [main repository](https://github.com/Wasabi-Wallet/WalletWasabi).

[![Build Status](https://dev.azure.com/Wasabi-Wallet/WasabiDoc/_apis/build/status/Wasabi-Wallet.WasabiDoc?branchName=master)](https://dev.azure.com/Wasabi-Wallet/WasabiDoc/_build/latest?definitionId=4&branchName=master)

---

# 🏛️ The pillars of the documentation

* ## [Why Wasabi](https://github.com/Wasabi-Wallet/WasabiDoc/tree/master/docs/why-wasabi/)
  * Why privacy is important.
* ## [Using Wasabi](https://github.com/Wasabi-Wallet/WasabiDoc/tree/master/docs/using-wasabi/)
  * How to use Wasabi Wallet.
* ## [Building Wasabi](https://github.com/Wasabi-Wallet/WasabiDoc/tree/master/docs/building-wasabi/)
  * How to contribute to Wasabi.
* ## [Wasabi FAQ](https://github.com/Wasabi-Wallet/WasabiDoc/tree/master/docs/FAQ/)
  * Frequently asked questions.
* ## [Wasabi Glossary](https://github.com/Wasabi-Wallet/WasabiDoc/tree/master/docs/glossary/)
...
The is built using an open-source static site generator called VuePress.
Its [configuration](https://github.com/Wasabi-Wallet/WasabiDoc/blob/master/docs/.vuepress/config.js) and [theme](https://github.com/Wasabi-Wallet/WasabiDoc/tree/master/docs/.vuepress/styles) are extremely customizable, and it offers great defaults out-of-the-box.
...
The images are stored in the [`/docs/.vuepress/public/`](https://github.com/Wasabi-Wallet/WasabiDoc/tree/master/docs/.vuepress/public) directory.
...
To have a single place to maintain universal strings like the current Wasabi version number, we use variables in the Markdown (i.e.  `${currentVersion}`and `${Wasabi-WalletPublicKeyFingerprint}`).
These variables are managed in [`docs/.vuepress/variables.js`](https://github.com/Wasabi-Wallet/WasabiDoc/blob/master/docs/.vuepress/variables.js).
